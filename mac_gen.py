...
Original file is located at
    https://colab.research.google.com/drive/1mTW63U-D-WXhk9qATXggR9r6XjBRNomV
"""
...
#by Gianmarco Foroni under CC0
from random import choice, randint
mac = choice(data.split("\n")).split("\t")
mac = {
    "code": mac[0],
    "vendor": mac[1]
}
for i in range(3):
  mac["code"] = mac["code"] + str(hex(randint(0, 255)))[2:]
mac["code"] = mac["code"].upper()
print(mac["code"])
input()
print(mac["vendor"])